...
- Adzuna + public Greenhouse/Lever boards: multi-source market search for location sweeps
...
5. Add `OPENAI_API_KEY`, `DATABASE_URL`, `APP_URL`, `ADZUNA_APP_ID`, `ADZUNA_APP_KEY`, and optionally `OPENAI_PARSER_MODEL`, `ADZUNA_COUNTRY`, `GREENHOUSE_BOARD_TOKENS`, and `LEVER_POSTING_SITES` in Vercel.
...
- curated public Greenhouse and Lever company boards by default
- optional extra Greenhouse and Lever board tokens from `GREENHOUSE_BOARD_TOKENS` and `LEVER_POSTING_SITES`
